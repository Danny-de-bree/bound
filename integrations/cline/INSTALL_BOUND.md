...
> **Type: Instruction-only.** This integration provides a prompt that Cline
> reads and follows. It is **not enforced** — there are no programmatic hooks
> into Cline's event system, rules, MCP servers, or lifecycle events. BOUND
> evaluates decisions; Cline is responsible for acting on them. The agent
